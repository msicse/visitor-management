...
<body class="h-screen">
                ...
                <div class="flex gap-16">
                    <div class="w-1/2 ">
                        ...
                        <div class="flex flex-col mb-2">
                            <label for="employee" class="text-md font-medium py-2 ">Whom to Meet <span
                                    class=" text-red-600 pl-1">*</span></label>
    ...
    <div id="spinnerModal"
        class="fixed inset-0 flex items-center justify-center bg-slate-200 bg-opacity-80 z-50 hidden">
