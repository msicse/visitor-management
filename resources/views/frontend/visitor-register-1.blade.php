...
<head>
    ...
    <style>
        ...
        * { font-family: 'Inter', ui-sans-serif, system-ui, sans-serif; }
        ...
        .section-card { background: #fff; border: 1px solid #e5e7eb; border-radius: 0.9rem; box-shadow: 0 1px 2px rgba(0,0,0,.03); }
        .section-head { display:flex; align-items:center; gap:.5rem; padding: .6rem .9rem; border-bottom:1px solid #f1f5f9; }
        .section-badge {
        ...
        /* Camera frame */
        #my_camera, #results { width: 200px; height: 152px; }
        ...
        #vtable thead th {
            ...
            background: #f8fafc; color:#64748b; font-size:.65rem; font-weight:700;
            text-transform: uppercase; letter-spacing:.04em; padding:.4rem .6rem; text-align:left;
            border-bottom:1px solid #e5e7eb;
        }
        #vtable td { padding:.35rem .5rem; border-bottom:1px solid #f1f5f9; }
...
<body class="h-screen flex flex-col overflow-hidden bg-gray-50 text-gray-800">
    ...
    <header class="shrink-0 bg-white border-b border-gray-200">
        <div class="max-w-screen-2xl mx-auto flex items-center justify-between px-4 sm:px-6 py-2">
            ...
            <div class="text-center">
                ...
                <p class="text-[11px] text-gray-500 hidden sm:block">Front Desk Kiosk</p>
            </div>
            <a href="{{ route('login') }}"
    ...
    <form action="#" id="addVisitorForm" class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 flex overflow-hidden gap-4 max-w-screen-2xl mx-auto w-full px-4 sm:px-6 pt-3 pb-2">

            <!-- Left column: photo -->
            <aside class="w-52 xl:w-60 shrink-0">
                <div class="section-card p-3.5">
                    <div class="flex items-center gap-2 mb-2.5">
                        ...
                        <h2 class="text-xs font-semibold text-gray-900">Visitor Photo <span class="required-star">*</span></h2>
                    </div>

                    <div class="relative mx-auto rounded-lg overflow-hidden border-2 border-dashed border-gray-300 bg-gray-50 flex items-center justify-center" style="width:200px;height:152px;">
                    ...
                    <input type="button" id="snapshotBtn"
                        class="mt-2.5 w-full inline-flex items-center justify-center gap-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold py-2 transition cursor-pointer"
                        value="Take Photo" onClick="take_snapshot()">
                    <p class="text-[10.5px] text-gray-400 mt-1.5 text-center leading-snug">Face the camera clearly before capturing</p>
                </div>
            </aside>
            ...
            <div class="flex-1 flex flex-col overflow-hidden gap-3">
                ...
                <div class="flex-1 overflow-y-auto space-y-3 pr-1">
                    ...
                    <div class="section-card">
                        ...
                        <div class="p-4 grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-3">
                            <div>
                    ...
                    <!-- Accompanying guests -->
                    <div class="section-card">
                        <div class="section-head justify-between">
                            <div class="flex items-center gap-2">
                                <span class="section-badge">2</span>
                                <h2 class="text-xs font-semibold text-gray-900">Accompanying Guests <span class="text-gray-400 font-normal">(optional)</span></h2>
                            </div>
                            <button type="button" id="addVisitor"
                                class="inline-flex items-center gap-1 rounded-full bg-blue-600 hover:bg-blue-700 text-white text-[11px] font-semibold px-3 py-1.5 transition">
                        ...
                        <div class="p-3">
                            <div class="overflow-auto rounded-lg border border-gray-200 max-h-40">
                ...
                <div class="shrink-0 flex justify-end gap-3 pt-2 border-t border-gray-200">
    ...
    <script>
        ...
        function take_snapshot() {
            Webcam.snap(function (data_uri) {
                ...
                document.getElementById('results').innerHTML = '<img height="152px" width="200px" src="' + data_uri + '"/>';
        ...
        $('#addVisitor').click(function (e) {
            ...
            for (j = 0; j <= rowCount; j++) {
                row.innerHTML = `<td class="text-xs text-gray-500 font-medium">` + j + `</td>

                <td><input type='text' name="guest_card_no[]" class="form-control !py-1.5 !text-xs guest-card-id" placeholder="Card ID" required onblur="checkGuestCardId(this)" /></td>
